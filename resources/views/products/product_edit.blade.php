...
<main class="col-md-9 ms-sm-auto col-lg-10 main-content">
   ...
   <div class="container-fluid">
      <form id='product-form' method="post" action="{{ url('product-update') }}">
       @csrf
         <div class="row">
           <div class="col-md-4">            
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="whole_sale" value="{{ $product->whole_sale }}">
            @error('whole_sale')
            <p class="text-danger">{{ $message }}</p>
            @enderror
         </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="retail" value="{{ $product->retail }}">
            @error('retail')
            <p class="text-danger">{{ $message }}</p>
            @enderror
          </div>
